...
public class DatabaseContextFactory : IDesignTimeDbContextFactory<DatabaseContext>
{
    ...
    public DatabaseContext CreateDbContext(string[] args)
    {
        ...
        var databaseName = configuration["PG_CONNECTION_DATABASE_NAME"];
        var connectionString = $"Server={server};Port={port};User Id={user};Password={password};Database={databaseName}";
