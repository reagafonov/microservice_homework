...
public class AccountSimpleFilterQuery : ISimpleFilterQuery<Account, AccountFilter>
{
    /// <summary>
    ...
    public IQueryable<Account> Filter(IQueryable<Account> query, AccountFilter filter)
    {
